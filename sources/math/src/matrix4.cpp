...
float32 AR_VEC_CALL Matrix4::getDeterminantFull(void) const
{
#ifdef AR_SIMD
...
float32 AR_VEC_CALL Matrix4::getDeterminantFast(void) const
{
#ifdef AR_SIMD
...
Matrix4 AR_VEC_CALL Matrix4::getTransposed(void) const
{
#ifdef AR_SIMD
...
Matrix4 AR_VEC_CALL Matrix4::getInverted(void) const
{
	AR_ASSERT_MSG(getDeterminantFull() != 0.f, "Determinant is zero");
...
Matrix4& AR_VEC_CALL Matrix4::invert(void)
{
	*this = getInverted();
