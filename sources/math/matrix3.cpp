...
float32 AR_VEC_CALL Matrix3::Determinant(void) const
{
#ifdef AR_SIMD
...
Matrix3 AR_VEC_CALL Matrix3::Transposed(void) const
{
#ifdef AR_SIMD
...
Matrix3 AR_VEC_CALL Matrix3::Inverted(void) const
{
