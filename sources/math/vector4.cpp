...
float32 AR_VEC_CALL Vector4::Length(void) const
{
	return std::sqrt(this->Dot(*this));
}

float32 AR_VEC_CALL Vector4::LengthSq(void) const
{
...
Vector4 AR_VEC_CALL Vector4::Normalized(void) const
{
	AR_ASSERT_MSG(!IsZeroEpsilon(), "Trying to normalize vector of length 0");
	return *this / Length();
}
...
{
#ifdef AR_SIMD
	return Vector4(_mm_xor_ps(m_data, MathUtils::c_SIMDNegMask));
#else
